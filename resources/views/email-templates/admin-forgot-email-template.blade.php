<p>Dear {{ $admin->name }}</p>
<p>
    We are received a request to reset the password for {{ env('APP_NAME') }} account associated with {{ $admin->email }}.
    ...
    <br>
    If you did not request for a password reset, please ignote this email.
</p>
